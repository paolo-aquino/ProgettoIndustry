 ...
 */
public class SupsiUltrasonicRanger extends GroveUltrasonicRanger implements SupsiMonitor<Double> {
     ...
     */
    public SupsiUltrasonicRanger(GrovePi grovePi, int pin, long readInterval) {
        super(grovePi, pin);
